...
var _message_writer = __webpack_require__(57);

var _message_writer2 = _interopRequireDefault(_message_writer);
...
var App = function (_Component) {
    ...
    _createClass(App, [{
        ...
        value: function componentDidMount() {
            var self = this;
            _index2.default.get('message/index').then(function (response) {
                var data = response.data;
                self.setState({ messages: data }, function () {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "div",
                    { className: "message-list", ref: function ref(el) {
                            _this2.messageList = el;
                        } },
                    this.state.messages.map(function (msg) {
                        return _react2.default.createElement(_message2.default, { type: msg.message_type, author: msg.author, date: msg.created_at, content: msg.content, key: 'msg_' + msg.id });
                    })
                ),
                _react2.default.createElement(_message_writer2.default, { postMessage: function postMessage(msg) {
                        return _this2.postMessage(msg);
                    } })
            );
        }
    }]);
...
var MessageWriter = function (_Component) {
    _inherits(MessageWriter, _Component);

    function MessageWriter(props) {
        _classCallCheck(this, MessageWriter);

        var _this = _possibleConstructorReturn(this, (MessageWriter.__proto__ || Object.getPrototypeOf(MessageWriter)).call(this, props));
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'composer' },
                    _react2.default.createElement('textarea', { value: this.state.content, onChange: function onChange(e) {
                            return _this2.setState({ content: e.target.value });
                        }, maxLength: '512',
                        onKeyDown: function onKeyDown(e) {
                            return _this2.onEnterPress(e);
                        } })
                ),
                _react2.default.createElement(
                    'div',
